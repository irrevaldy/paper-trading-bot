...
from app.market.indicators import ema, average
from app.models import Signal
from app.strategy.base import BaseStrategy


class TrendVolumeImbalanceStrategy(BaseStrategy):
    ...
    def evaluate(self, symbol: str) -> Signal:
        ...
        if not has_position:
            if bullish_trend and volume_spike and healthy_spread and bullish_imbalance:
        ...
        trend_lost = short_ema < long_ema
        heavy_ask_pressure = orderbook["imbalance_ratio"] < 0.9

        if trend_lost and heavy_ask_pressure:
